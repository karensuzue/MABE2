 ...
 *  @date 2019-2021.
 *
 *  @file EvalTaskXor.cpp 
 *  @brief Test file for the XOR boolean logic task that is called via IO instruction
 */
...
TEST_CASE("EvalTaskXor", "[evaluate/callable]"){
  ...
  task.AddOwnedTrait<bool>("xor_performed", "Was and performed?", false);
  ...
  CHECK(!org.GetTrait<bool>("xor_performed"));
