 ...
 *  @date 2019-2022.
 *
 *  @file  VirtualCPUOrg_Inst_Manipulation.cpp
 *  @brief Test functionality of Manipulation instructions for VirtualCPUOrgs. 
 */
...
TEST_CASE("VirtualCPUOrg_Inst_Manipulation_Main", "[orgs/instructions]"){
}
