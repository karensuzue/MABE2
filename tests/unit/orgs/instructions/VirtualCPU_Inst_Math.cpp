 ...
 *  @date 2019-2022.
 *
 *  @file  VirtualCPUOrg_Inst_Math.cpp
 *  @brief Test functionality of Math instructions for VirtualCPUOrgs. 
 */
...
TEST_CASE("VirtualCPUOrg_Inst_Math_Main", "[orgs/instructions]"){
}
