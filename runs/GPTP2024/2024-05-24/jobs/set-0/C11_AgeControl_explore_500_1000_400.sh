...
RUN_DIR=/mnt/c/Users/HP/Documents/GitHub/MABE2/runs/GPTP2024/2024-05-24/C11_AgeControl_explore_500_1000_400_${SEED}  # run dir is CONFIG_DIR or REPO_DIR / DATA_DIR/
...
RUN_PARAMS="--SEED ${SEED} --elite_count 0 --filename AgeControl.mabe --inject_step 100 --num_gens 2000000 --print_step 1000000 -s diagnostics.diagnostic="explore" -s pop_size=1000 -s inject_count=400 -s num_vals=500"
